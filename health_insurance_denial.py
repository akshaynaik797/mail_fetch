...
try:
    ...
    if f.find('Claim Number')!=-1:
      ...
      hg.append(f[w:u])
          ...
          print("Claim Number not present")
    ...
    if f.find('Patient’s Member UHID')!=-1:
      ...
      hg.append(f[w:u])
          ...
          print("Patient’s Member UHID not present")
    ...
    if f.find('Patient Name')!=-1:
        ...
        hg.append(f[w:w+50])
          ...
          print("Patient Name not present")
    ...
    try:
        subprocess.run(["python", "test_api.py",hg[0],'',hg[3],'','Denial',sys.argv[6],sys.argv[1],'',hg[1],hg[2]])
